  ...
  return (
    <>
      ...
      <nav style={styles.nav}>
        <NavLink to="/groups" style={({ isActive }) => ({ ...styles.navItem, color: isActive ? '#6366f1' : '#9ca3af' })}>
          <span style={styles.icon}>⊞</span>
          <span style={styles.label}>Groups</span>
        </NavLink>

        <NavLink to="/expenses" style={({ isActive }) => ({ ...styles.navItem, color: isActive ? '#6366f1' : '#9ca3af' })}>
          <span style={styles.icon}>₹</span>
          <span style={styles.label}>Expenses</span>
        </NavLink>

        <NavLink to="/settlements" style={({ isActive }) => ({ ...styles.navItem, color: isActive ? '#6366f1' : '#9ca3af' })}>
          <span style={styles.icon}>✓</span>
          <span style={styles.label}>Settlements</span>
        </NavLink>

        <button style={styles.navItem} onClick={() => setShowProfile(true)}>
